	...
	public static void main(String[] args) throws InterruptedException {

		{
...

			{
				...
				Thread.sleep(2000);
				driver.findElement(By.xpath("(//td[@class='cursorPointer py-2 ps-4 deSelect'])[7]")).click();
				Thread.sleep(2000);
				driver.findElement(By.xpath("(//td[@class='cursorPointer py-2 ps-4 deSelect'])[4]")).click();
				Thread.sleep(3000);
