...
public class SheduleCall_Create_Edit {
...
}
{
	...
	//driver.findElement(By.xpath("//div[@class='columns_container ps-4 pe-2 pt-2 pb-3']")).click();
	Thread.sleep(2000); 
//	//WebElement modal = driver.findElement(By.xpath("//div[@class='columns_container ps-4 pe-2 pt-2 pb-3']")); 
...
//		driver.findElement(By.xpath("//button[@class='save_btn']")).click();
		 try {
	            ...
	            // If the button is not found, handle the exception and proceed
	            System.out.println("Create button not found. Nothing is overlapping...");
	            // Proceed to the next step
	            // Add your next step here, e.g., navigating to another page or performing other actions
	        }
		 Thread.sleep(2000);
			...
			driver.findElement(By.xpath("(//li[@class='dropdown-item cursorPointer'])[3]")).click();
			driver.findElement(By.xpath("//button[@class='save_btn py-2 border border-0 rounded-2']")).click();
			{
